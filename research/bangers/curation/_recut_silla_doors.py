...
# Forgotten #1 Un Beso at #3. Medicina / Culpable / Dime / Me Voy for wow.
# Nereyda stays in the 100, not the throne. Aventura 12.
# ---------------------------------------------------------------------------
AYER_15 = [
    ...
    ("oVLS7QGWlGw", "Antony Santos", "Voy Pa'llá", 1992, "Anthony Santos", 7100000),
...
AYER_TAIL = [
    ...
    ("66qBzWshc_w", "Kiko Rodríguez", "Hoy Te Vi Pasar", 2002, "Kiko Rodriguez", 52300000),
...
# ---------------------------------------------------------------------------
# HOY — Romeo/Royce house pair + típica-now as LEADS.
# Authored #1 Propuesta. Forgotten #1 Darte un Beso.
# La Asesina / Imitadora / El Amor Que Perdimos raise the wow.
...
HOY_15 = [
    ...
    ("MB23TtaeiQY", "Zacarías Ferreira", "La Asesina", 2018, "Zacarias Ferreira Oficial", 393400000),
    ...
    ("AL_Ogy2TTXs", "El Chaval de la Bachata", "Dile A Él", 2019, "El Chaval de la Bachata", 89000000),
    ...
    ("Bbu6K6DWQAA", "Raulín Rodríguez", "Corazón Con Candado", 2017, "Planet Records Official", 43600000),
    ("iuugCBK3RRI", "Antony Santos", "Creíste", 2013, "Anthony Santos", 11700000),
]

HOY_FALLBACK = {
    "Bbu6K6DWQAA": ("TZdV0BvZW6o", "Raulín Rodríguez", "Corazón Con Candado", 2017, "Planet Records Official", 43561264),
}
...
HOY_TAIL = [
    ...
    ("59_5CFuPvPc", "Zacarías Ferreira", "Me Sobran Las Palabras", 2020, "Zacarias Ferreira Oficial", 60500000),
    ...
    ("mp-g0oAGrOw", "Héctor Acosta", "Si No Me Falla El Corazón", 2014, "Hector Acosta", 0),
    ("17fGLPG4Wtw", "Antony Santos", "Ay Chichi", 2023, "Anthony Santos", 0),
    ("F_l_I-QlcyE", "Héctor Acosta", "Ya Fue Bastante", 2022, "EL TORITO OFICIAL", 0),
    ("J9tC0cPsz3g", "Kiko Rodríguez", "Yo Fui el Primero", 2016, "Kiko Rodriguez", 9800000),
    ...
    ("L48Mw2W6v6Q", "Joe Veras", "Tu Excusa", 2025, "Joe Veras Oficial", 0),
    ("Ra5xGEPlIjw", "Kiko Rodríguez", "Usted No Sabe", 2025, "Kiko Rodriguez", 0),
    ("I68EMkzz3jI", "Joe Veras", "Aunque No Sea Conmigo", 2025, "Joe Veras Oficial", 0),
    ("Xr_jslGVFvo", "Grupo Extra", "Me Emborracharé", 2014, "Grupo Extra", 0),
    ("tP_XZ0teEno", "Yoskar Sarante, El Chaval de la Bachata", "Tres Veces", 2015, "Yoskar Sarante", 0),
    ("IFfLjoKsHX0", "Grupo Extra", "Qué Mal Te Hice Yo", 2015, "Grupo Extra", 0),
    ("CDv6lGEaWTo", "Henry Santos", "Por Nada", 2012, "Henry Santos", 2400000),
    ("W1_7r-7D74I", "Grupo Extra", "Te Vas", 2013, "Grupo Extra", 0),
    ("DiZEZg93U1E", "Elvis Martínez", "Ambición", 2012, "Elvis Martinez", 0),
    ("nKN8tTN-_O0", "Grupo Extra", "Tengo Una Necesidad", 2014, "Grupo Extra", 0),
    ("R5V-A-iu9dg", "Henry Santos, Pavel Núñez", "Te Di", 2015, "Henry Santos", 0),
    ("9kbFdKX1rJw", "Grupo Extra", "Lejos de Ti", 2016, "Grupo Extra", 0),
    ("1S7SJcEKfuY", "Elvis Martínez", "Tú Sabes Bien", 2017, "Elvis Martinez", 0),
    ("Q2HftVyi6wc", "Grupo Extra, Lirow", "Cuando Te Vuelva a Ver", 2018, "Grupo Extra", 0),
    ("DjEttgmfNCU", "Henry Santos, JFab, Paola Fabre", "Cuando Te Toco", 2020, "Henry Santos", 0),
    ("Lpj2epjATXM", "Yoskar Sarante", "Quién Eres Tú", 2014, "Yoskar Sarante", 0),
    ("2Y6uAa6Jnpw", "Henry Santos", "Poquito A Poquito", 2011, "Henry Santos", 4900000),
    ...
    ("uUeNpTC7UWI", "Pinto Picasso", "No Me Toca", 2018, "Pinto Picasso", 0),
    ...
    ("bOltNO3gw64", "Zacarías Ferreira", "No Me Entendió", 2019, "Zacarias Ferreira Oficial", 0),
    ("k4UMOZ_Ec28", "El Chaval de la Bachata", "Te Puedes Quedar", 2019, "El Chaval de la Bachata", 12900000),
    ("ntOjtjk7qTo", "Frank Reyes", "Aventurero", 2021, "Frank Reyes", 1400000),
    ("Mp9Zax95fYI", "Frank Reyes", "Me Dejaste Abandonado", 2016, "Frank Reyes", 0),
    ("VafbNsrHnD8", "Romeo Santos", "Llévame Contigo", 2011, "RomeoSantosVEVO", 185200000),
    ("exW9PGRGonk", "Romeo Santos, Kiko Rodríguez", "El Beso Que No Le Di", 2019, "RomeoSantosVEVO", 0),
    ("yjdHGmRKz08", "Romeo Santos, Teodoro Reyes", "Ileso", 2019, "RomeoSantosVEVO", 0),
    ("y_NIPfqzf78", "Romeo Santos, Joe Veras", "Amor Enterrado", 2019, "RomeoSantosVEVO", 0),
    ("gSf11ejU0k8", "Frank Reyes", "Aventurero (Video)", 2021, "Frank Reyes", 0),
    ("JRtiliI_MQ8", "Romeo Santos, Luis Miguel del Amargue", "La Última Vez", 2019, "RomeoSantosVEVO", 0),
    ("1ejl3mnmXQQ", "El Chaval de la Bachata, Dalvin La Melodia", "Antes y Después", 2025, "El Chaval de la Bachata", 9400000),
    ("Lpj2epjATXM", "Yoskar Sarante", "Quién Eres Tú", 2014, "Yoskar Sarante", 0),
]
...
def cap_tail(head: list, tail: list, kings: set[str], king_cap: int = 18, other_cap: int = 12) -> list:
    counts = Counter(lead(r[1]) for r in head)
    kept = []
    for r in tail:
        a = lead(r[1])
        cap = king_cap if a in kings else other_cap
        if counts[a] >= cap:
            print(f" CAP skip {r[1]} — {r[2]} ({counts[a]} already)")
            continue
        kept.append(r)
        counts[a] += 1
    return kept
...
def hygiene(tracks: list, era: str) -> None:
    ...
    over12 = [(a, c) for a, c in Counter(lead(t["artist"]) for t in tracks).items() if c > 12]
    print("over18", over, "kings13-18", mid, "over12", over12)
    years = [t["year"] for t in tracks]
    print(f"year min={min(years)} max={max(years)}")
    in15 = [t for t in tracks if t.get("intro")]
    print("intro flags", len(in15))
...
def main() -> None:
    ...
    ayer_tail = cap_tail(ayer_15, ayer_tail, {"aventura"}, 12, 12)
    ...
    hoy_15 = apply_fallbacks(HOY_15, hoy_recs, HOY_FALLBACK)
    need = [r for r in hoy_15 if r[0] not in hoy_recs or not hoy_recs[r[0]].get("ok")]
    if need:
        extra = verify_rows(need)
        hoy_recs.update(extra)
    ...
    hoy_tail = cap_tail(hoy_15, hoy_tail, {"romeo santos"}, 14, 12)
    ...
    if len({t["id"] for t in ayer_tracks}) != 100:
        raise SystemExit("AYER dup ids")
    if len({t["id"] for t in hoy_tracks}) != 100:
        raise SystemExit("HOY dup ids")
